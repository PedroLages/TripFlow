...
const DocumentsTab: React.FC<DocumentsTabProps> = ({ trip, updateTrip }) => {
  ...
  return (
    <div className="p-4 md:p-10 max-w-7xl mx-auto space-y-16 pb-32 no-scrollbar">
      ...
      {showCamera && (
        <div className="fixed top-20 left-0 right-0 bottom-20 md:bottom-0 z-[120] flex flex-col items-center justify-center p-4 bg-[#0a0e1a]/98 backdrop-blur-2xl">
      ...
      {/* Smart Import Modal */}
      {showSmartImport && (
        <div className="fixed top-20 left-0 right-0 bottom-20 md:bottom-0 z-[150] flex items-center justify-center p-4 sm:p-6 bg-[#0a0e1a]/98 backdrop-blur-2xl">
